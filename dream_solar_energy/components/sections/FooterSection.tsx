...
export default function FooterSection() {
  ...
  return (
    <footer className="bg-[#0F1B2E] text-[#EFEDE7]/80 pt-16 pb-8 px-4 sm:px-6 lg:px-8 border-t border-[#1B2A4A]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#1B2A4A]">
          ...
          <div className="lg:col-span-4 space-y-4">
            <Link href="/" className="inline-flex items-center gap-3">
              <div className="relative w-12 h-12 rounded-[8px] overflow-hidden border border-[#22325A] shadow-site flex items-center justify-center flex-shrink-0 bg-white p-0.5">
            ...
            {/* Owner info */}
            <div className="flex items-center gap-2.5 bg-[#1B2A4A] border border-[#22325A] rounded-[8px] px-4 py-2.5 max-w-sm">
              <div className="relative w-9 h-9 rounded-[6px] overflow-hidden border border-[#F7941D]/40 flex-shrink-0 bg-[#0F1B2E]">
                <Image
            ...
            <div className="pt-1">
              <button
                onClick={() => openModal()}
                className="inline-flex items-center gap-2 bg-[#F7941D] hover:bg-[#EE6B00] text-[#0F1B2E] font-bold text-xs px-4 py-2.5 rounded-[8px] transition-colors shadow-site"
                style={{ fontFamily: "var(--font-outfit)" }}
              >
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            >
              <MapPin className="w-4 h-4 text-[#F7941D] flex-shrink-0 mt-0.5" />
              <span>
            ...
            <div className="flex items-center gap-2.5 text-xs sm:text-sm">
              <MessageSquare className="w-4 h-4 text-[#7CB342] flex-shrink-0" />
              <a
            ...
            <div className="flex items-center gap-2.5 text-xs sm:text-sm">
              <Mail className="w-4 h-4 text-[#FBB859] flex-shrink-0" />
              <a
            ...
            <div className="flex items-start gap-2.5 text-xs text-[#EFEDE7]/60 pt-2 border-t border-[#1B2A4A]">
              <Clock className="w-4 h-4 text-[#5B6472] flex-shrink-0 mt-0.5" />
              <div>
