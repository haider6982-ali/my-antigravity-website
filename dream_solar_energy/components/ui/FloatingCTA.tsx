  ...
  return (
    <div className="fixed bottom-5 right-4 z-40 flex flex-col items-end gap-2.5 pointer-events-auto">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1EBE5D] text-white p-3 sm:px-4 sm:py-2.5 rounded-full shadow-lg hover:shadow-xl transition-all active:scale-95 group"
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 bg-[#0D2354] hover:bg-[#163574] text-white p-3 sm:px-4 sm:py-2.5 rounded-full shadow-lg hover:shadow-xl transition-all active:scale-95 border border-white/20"
        style={{ fontFamily: "var(--font-outfit)" }}
      >
